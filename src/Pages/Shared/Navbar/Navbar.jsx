...
const menuItem = <>
    ...
    <li className=' uppercase'><Link className='hover:text-[#EEFF25] active:text-[#EEFF25]' to="/dashboard/user-home">Dashboard</Link></li>
                            ...
                            <div className="dropdown dropdown-end">
                                ...
                                <ul tabIndex={0} className="menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow bg-info rounded-box w-52">
                                    <li className='hover:text-white'>
                                        <a className="justify-between className='hover:text-white'">
                                            {user?.displayName}
